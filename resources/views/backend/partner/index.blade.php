            ...
            <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <a class="btn btn-sm btn-primary float-right" href="{{ route('admin.partner.create') }}">Create New Business Partner</a>
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        @foreach ($partners as $key => $partner)
                            <tr>
                                <td width="30" class="text-center">{{ $partners->firstItem() + $key }}</td>
                                <td>{{ $partner->name }}</td>  
                                <td class="text-center">
                                    @if ($partner->photo)
                                    <img style="border-radius: 50%" src="{{ asset('storage/'.$partner->photo) }}" width="50">
                                    @else
                                ...
                                <td width="100" class="text-center">
                                    ...
                                    <button class="btn btn-sm btn-danger" type="button" onclick="deleteTestimonial({{ $partner->id }})">
