            ...
            <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <a class="btn btn-sm btn-primary float-right" href="{{ route('admin.team.create') }}">Create New Team</a>
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        @foreach ($teams as $key => $team)
                            <tr>
                                <td width="30" class="text-center">{{ $teams->firstItem() + $key }}</td>
                                <td>{{ $team->name }}</td>  
                                ...
                                <td class="text-center">
                                    @if ($team->photo)
                                    <img style="border-radius: 50%" src="{{ asset('storage/'.$team->photo) }}" width="50">
                                    @else
                                ...
                                <td width="100" class="text-center">
                                    <a href="{{ route('admin.team.edit', $team->id) }}" class="btn btn-sm btn-primary">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button class="btn btn-sm btn-danger" type="button" onclick="deleteTestimonial({{ $team->id }})">
