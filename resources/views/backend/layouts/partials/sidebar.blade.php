<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('admin.dashboard') }}" class="brand-link">
      <img src="{{ asset('assets/backend/img/logo.png') }}" alt="{{ config('app.name', 'Laravel') }} Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('admin.specification.create') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create Specification </p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('admin.specification.index') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
