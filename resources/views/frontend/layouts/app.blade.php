                ...
                <div id="site-logo" class="clearfix">
                    <div id="site-logo-inner">
                        <a href="{{route('home')}}" title="Construction" rel="home" class="main-logo">
                            <img src="{{ asset('storage/' . $settings->logo) }}" alt="{{ config('app.name', 'Laravel') }} Logo" data-retina="assets/img/logo-light@2x.png" height="80" width="80" data-width="80" data-height="30">
                        </a>
                    </div>
                </div><!-- /#site-logo -->
            ...
            <div class="col-md-3">
                <div class="widget widget_tag_cloud">
                    ...
                    <div class="tagcloud">
                        ...
                        <a href="{{route('blog.details',[$footerBlog->id,$footerBlog->title])}}">{{$footerBlog->title}}</a>
                        @endforeach
...
<!-- Revolution Slider -->
<script type="text/javascript" src="{{asset('/')}}assets/frontend/includes/rev-slider/js/jquery.themepunch.tools.min.js"></script>
<script type="text/javascript" src="{{asset('/')}}assets/frontend/includes/rev-slider/js/jquery.themepunch.revolution.min.js"></script>
<script type="text/javascript" src="{{asset('/')}}assets/frontend/assets/js/rev-slider.js"></script>
<!-- Load Extensions only on Local File Systems ! The following part can be removed on Server for On Demand Loading -->  
<script type="text/javascript" src="{{asset('/')}}assets/frontend/includes/rev-slider/js/extensions/revolution.extension.actions.min.js"></script>
<script type="text/javascript" src="{{asset('/')}}assets/frontend/includes/rev-slider/js/extensions/revolution.extension.carousel.min.js"></script>
<script type="text/javascript" src="{{asset('/')}}assets/frontend/includes/rev-slider/js/extensions/revolution.extension.kenburn.min.js"></script>
<script type="text/javascript" src="{{asset('/')}}assets/frontend/includes/rev-slider/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script type="text/javascript" src="{{asset('/')}}assets/frontend/includes/rev-slider/js/extensions/revolution.extension.migration.min.js"></script>
<script type="text/javascript" src="{{asset('/')}}assets/frontend/includes/rev-slider/js/extensions/revolution.extension.navigation.min.js"></script>
<script type="text/javascript" src="{{asset('/')}}assets/frontend/includes/rev-slider/js/extensions/revolution.extension.parallax.min.js"></script>
<script type="text/javascript" src="{{asset('/')}}assets/frontend/includes/rev-slider/js/extensions/revolution.extension.slideanims.min.js"></script>
<script type="text/javascript" src="{{asset('/')}}assets/frontend/includes/rev-slider/js/extensions/revolution.extension.video.min.js"></script>
